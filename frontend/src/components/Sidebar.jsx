...
<aside className="relative w-[260px] min-w-[260px] flex-shrink-0 h-full overflow-y-auto bg-slate-100 border-r border-gray-200 p-6">
      <div className="mb-6">
        ...
        <select className="block w-full rounded-lg border border-gray-300 bg-white p-2">
        ...
        <ol className="space-y-4">
          {stops.map((s, i) => (
            <li key={i} className="flex items-start space-x-3">
              <div className="mt-1 w-6 h-6 bg-blue-600 text-white flex items-center justify-center rounded-full">
                {i + 1}
              </div>
